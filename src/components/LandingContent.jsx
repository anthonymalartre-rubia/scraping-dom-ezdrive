        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              {/* H1 MASSIVE — Hero retenu : "Apollo + Lemlist + HubSpot + Typeform. Un seul outil, 19 €/mois."
                  Style Plausible/Cal.com : on nomme les concurrents direct. Punchy, sans détour.
                  BRAND TODO Sprint Visuel : tester en A/B la variante "Apollo coûte 99$. Volia 19€. Vous voyez l'idée." */}
