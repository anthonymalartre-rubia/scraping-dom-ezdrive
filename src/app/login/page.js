    ...
    <div className="min-h-screen bg-surface-base flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <button
          ...
          className="w-full rounded-lg border border-line bg-surface-card hover:bg-surface-elevated px-4 py-2.5 text-sm font-medium text-content-primary disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2.5 mb-6"
        >
          {oauthLoading ? (
